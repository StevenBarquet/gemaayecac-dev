...
export const servicesPageData = {
  services: [
    ...
    {
      title: 'MEDIACIÓN',
      data: ['MASC', 'Proceso de mediación', '¿Es Mediable tu conflicto?'],
      path: '/mediacion'
    },
    {
      title: 'DEFENSA',
